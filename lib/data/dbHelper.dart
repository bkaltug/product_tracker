...
class DbHelper {
  ...
  Future<Database> initializeDb() async {
    ...
    Database eTradeDb = await openDatabase(dbPath, version: 1, onCreate:createDb);
    return eTradeDb;
  }
  ...
  Future<List<Products>> getProducts() async {
    ...
    return List.generate(result.length, (index) {
      return Products.fromObject(result[index]);
    });
  }

  Future<int> insert(Products product) async {
